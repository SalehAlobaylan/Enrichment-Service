...
Uses sentence-transformers' clip-ViT-B-32 — same library as the text embedder,
so no extra dependency. Output is a 512-dim L2-normalized vector suitable for
cosine-similarity search in pgvector.

Mirror of `models/embedder.py` to keep ModelManager's loading pattern uniform.
"""
