"""arq worker for long-running Enrichment jobs.
...
async def _startup(ctx: dict[str, Any]) -> None:
    ...
    # Worker loads the Whisper model on startup. Embeddings/CLIP aren't
    # needed in worker context, but ModelManager.warmup loads everything —
    # we accept that for now to keep the code path identical to the API.
