...
# Same status enum as transcribe / embed write-back.
...
class ImageEmbedResponse(BaseModel):
    ...
    the 384-dim text embedding on the same content_item. Both can coexist.
    """

    embedding: list[float]
    model: str
    dimensions: int
    # When content_id is supplied, Enrichment writes the vector to CMS via
